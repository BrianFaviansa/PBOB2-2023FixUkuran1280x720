...
{
    public partial class v_JadwalSemproKombi : Form
    {
        int id_jadwal_sempro;
        public v_JadwalSemproKombi()
        {
            InitializeComponent();
        ...
        private void v_JadwalSemproKombi_buttonJadwalSidang_Click(object sender, System.EventArgs e)
        {
            this.Hide();
        ...
        private void v_JadwalSemproKombi_buttonDataDosen_Click(object sender, System.EventArgs e)
        {
            this.Hide();
            new v_DataDosenKombi().Show();
        }

        private void v_JadwalSemproKombi_buttonArsipJudul_Click(object sender, System.EventArgs e)
        {
            this.Hide();
        ...
        private void v_JadwalSemproKombi_Load(object sender, System.EventArgs e)
        {
            dataGridView1.DataSource = PenjadwalanSemproContext.all();
        }
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            ...
            {
                PenjadwalanSemproContext.updateKombi(id_jadwal_sempro, Penguji1, Penguji2);
        ...
        private void button11_Click(object sender, EventArgs e)
        {
            ...
            {
                PenjadwalanSemproContext.updateKombi(id_jadwal_sempro, Penguji1, Penguji2);
                MessageBox.Show("Penguji berhasil dirubah", "Sukses", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                dataGridView1.DataSource = PenjadwalanSemproContext.all();
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            comboBox2.Text = dataGridView1.Rows[e.RowIndex].Cells[12].Value.ToString();
